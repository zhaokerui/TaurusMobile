package flashk.utils
{
	...
	public final class TextFieldUtil
	{
		 ...
		 * 
		 */
		public static function createBitmap(obj:DisplayObject):Bitmap
		{
			...
			{
				bitmap.x = (obj as DisplayObject).x + bounds.x;
				bitmap.y = (obj as DisplayObject).y + bounds.y;
			}
