package flashk.utils
{
	...
	[Event(name="tween_start",type="flashk.events.TweenEvent")]
	[Event(name="tween_end",type="flashk.events.TweenEvent")]
	[Event(name="tween_update",type="flashk.events.TweenEvent")]
	/**
