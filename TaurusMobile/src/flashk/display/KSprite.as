package flashk.display
{
	...
	public class KSprite extends Sprite
	{
		...
		public function KSprite(skin:*=null,replace:Boolean=true)
		{
			super();
		...
		public function setContent(skin:*,replace:Boolean=true):void
		{
			...
			{
				if (_content is UIBase && autoDestoryContent)
					(_content as UIBase).destory();
		...
		private function addedToStageHandler(event:Event):void
		{
			...
			dispatchEvent(new KEvent(KEvent.CREATE_COMPLETE));
		}
		...
		public function destory():void
		{
			...
			if (content is IBase && autoDestoryContent)
				(content as IBase).destory();
