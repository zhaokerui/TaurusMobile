package flashk.controls
{
	...
	import flashk.utils.MatrixUtil;
	...
	public class Text extends UIBase
	{
		...
		public function applyTextFormat(f:*=null,overwriteDefault:Boolean = false):void 
		{
			...
			if (!(f is TextFormat))
				f = DataUtil.createObject(TextFormat,f);
		...
		public function Text(skin:*=null, replace:Boolean=true, separateTextField:Boolean = false, textPadding:Padding=null)
		{
			if (!skin)
				skin = defaultSkin;
		 ...
		 * 
		 */
		public function createTextField(txt:String=""):TextField
		{
