package flashk.controls
{
	...
	import flashk.utils.load.LoadHelper;
	
	/**
	 * 加载进度条
	 * @author kerry
	 * @version 1.0.0 
	 * 创建时间：2013-6-20 下午4:45:22
	 * */     
	public class ProgressBar  extends PercentBar
	{
		public static var defaultSkin:*;
		
		public function ProgressBar(skin:*=null, replace:Boolean=true, mode:String="scaleX", fields:Object=null)
		{
			if (!skin)
				skin = defaultSkin;
		 ...
		 * 
		 */
		public static function defaultProgressFunction(progress:ProgressBar):void
		{
