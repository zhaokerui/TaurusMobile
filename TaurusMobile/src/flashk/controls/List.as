package flashk.controls
{
	...
	public class List extends ScrollPanel
	{
		 ...
		 * 列表容器 
		 */
		public var listContent:TileList;
		...
		public function List(skin:*=null,replace:Boolean = true, type:String = UIConst.VERTICAL,itemRender:* = null,fields:Object = null)
		{
			if (!fields)
				fields = listFields;
		...
		public override function setContent(skin:*, replace:Boolean=true) : void
		{
			...
			listContent = new TileList(renderSkin,replace,_type,_itemRender);
