package flashk.controls
{
	 ...
	 * @author kerry
	 * @version 1.0.0 
	 * 创建时间：2013-6-6 下午2:54:15
	 * */     
	public class ScrollPanel extends NoScale implements IScrollContent
	{
		/**
		 * 横向滚动条
		 */
		...
		public function ScrollPanel(skin:*,replace:Boolean = true,width:Number = NaN,height:Number = NaN,fields:Object = null)
		{
			if (fields)
				this.fields = fields;
