package flashk.controls
{
	...
	import flashk.utils.DisplayUtil;
	import flashk.utils.Geom;
	
	[Event(name="add_repeat_item",type="flashk.events.RepeatEvent")]
	
	[Event(name="remove_repeat_item",type="flashk.events.RepeatEvent")]
	 ...
	 * @author kerry
	 * @version 1.0.0 
	 * 创建时间：2013-6-6 下午3:21:46
	 * */     
	public class Tile extends UIBase
	{
