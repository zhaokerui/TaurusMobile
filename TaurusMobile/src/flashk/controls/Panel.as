package flashk.controls
{
	 ...
	 * @author kerry
	 * @version 1.0.0 
	 * 创建时间：2013-6-6 下午3:44:52
	 * */     
	public class Panel extends NoScale
	{
		/**
		 * 布局器
		 */
		...
		{
			target.addEventListener(KEvent.RESIZE,invalidateLayoutHandler,false,0,true);
		...
		{
			target.removeEventListener(KEvent.RESIZE,invalidateLayoutHandler);
